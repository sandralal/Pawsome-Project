...
<body>
    ...
    <header>
        ...
        <div class="logo-profile">
            <div class="userimg">
               <a href="#1234"><img src="./img/user.jpg"></a>
               <a href="#">Profile</a>
        </div>
    </div>  
    </header>
...
<span>
   ...
   <br><br> <input type="button"  onclick="location.href='http://localhost/php/mini-project/mini%20project/sitting_form.php';" value="Click For Registration" >  
    </div>
</div>
        <div class="sub2">
