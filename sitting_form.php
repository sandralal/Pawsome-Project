...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO pet_sitting(name,number,address,pet_name,pets,breed,sex,diet,payment,email) value ('$usname','$phn','$address','$petname','$pet','$breed','$sex','$diet','$payment','$curuser')";
...
<select name="payment" id="payment">
  ...
  <input type="submit" name="submit" id="submit" value="proceed to billing" onclick="location.href='http://localhost/php/mini-project/mini%20project/sitting_billing.php';" >
</form>
